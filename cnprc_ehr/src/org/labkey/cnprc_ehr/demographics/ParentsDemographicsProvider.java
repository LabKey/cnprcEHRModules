 ...
 * Time: 10:29 AM
 */
public class ParentsDemographicsProvider extends AbstractDemographicsProvider
{
    public ParentsDemographicsProvider(Module owner)
    {
        super(owner, "study", "DemographicsParentSpecies");
    ...
    protected Set<FieldKey> getFieldKeys()
    {
        ...
        keys.add(FieldKey.fromParts("damSpecies"));
        keys.add(FieldKey.fromString("sire"));
        keys.add(FieldKey.fromParts("sireSpecies"));

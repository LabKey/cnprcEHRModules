...
,CENTRAL_SPPLY_STATUS_CLOSED_YN        AS CENTRAL_SPPLY_STATUS_CLOSED_YN
,CENTRAL_SPPLY_STATUS_SET_BY           AS CENTRAL_SPPLY_STATUS_SET_BY
,CENTRAL_SPPLY_STATUS_TIMESTAMP        AS CENTRAL_SPPLY_STATUS_TIMESTAMP
...
,WORK_ORDERS_STATUS_CLOSED_YN          AS WORK_ORDERS_STATUS_CLOSED_YN
,WORK_ORDERS_STATUS_SET_BY             AS WORK_ORDERS_STATUS_SET_BY
,WORK_ORDERS_STATUS_TIMESTAMP          AS WORK_ORDERS_STATUS_TIMESTAMP
,CORE_SERVICES_STATUS_CLOSED_YN        AS CORE_SERVICES_STATUS_CLOSED_YN
,CORE_SERVICES_STATUS_SET_BY           AS CORE_SERVICES_STATUS_SET_BY
,CORE_SERVICES_STATUS_TIMESTAMP        AS CORE_SERVICES_STATUS_TIMESTAMP

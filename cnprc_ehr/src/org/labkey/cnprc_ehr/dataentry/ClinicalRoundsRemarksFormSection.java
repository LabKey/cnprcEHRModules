...
public class ClinicalRoundsRemarksFormSection extends RoundsRemarksFormSection
{
    ...
    public ClinicalRoundsRemarksFormSection(EHRService.FORM_SECTION_LOCATION location)
    {
        ...
        addClientDependency(ClientDependency.fromPath("cnprc_ehr/form/field/AdmitTypeField.js"));
        addClientDependency(ClientDependency.fromPath("ehr/window/AddClinicalCasesWindow.js"));
        addClientDependency(ClientDependency.fromPath("cnprc_ehr/window/AddClinicalCasesWindowWithAdmitType.js"));
        _showLocation = true;
    }
    ...
    public List<String> getTbarButtons()
    {
        ...
        defaultButtons.add(0, "ADDCNPRCCLINICALCASEBUTTON");

 ...
 * Time: 10:29 AM
 */
public class TBDemographicsProvider extends AbstractDemographicsProvider
{
    public TBDemographicsProvider(Module owner)
    {
        super(owner, "study", "DemographicsMostRecentTB");
    ...
    {
        return ("study".equalsIgnoreCase(schema) && "tb".equalsIgnoreCase(query));
    }
}

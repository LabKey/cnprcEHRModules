...
public class ClinicalObservationsFormSection extends SimpleFormSection
{
    ...
    {
        super("study", "clinical_observations", "Clinical Observations", "cnprc_ehr-clinicalobservationspanel", location);
        ...
        addConfigSource("ClinicalObservations");
        addClientDependency(ClientDependency.fromPath("cnprc_ehr/model/sources/ClinicalObservations.js"));

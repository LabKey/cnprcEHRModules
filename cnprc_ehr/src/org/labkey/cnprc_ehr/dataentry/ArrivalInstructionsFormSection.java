...
public class ArrivalInstructionsFormSection extends AbstractFormSection
{
    ...
    {
        super("Arrival", "Instructions", "cnprc_ehr-arrivalinstructionspanel");

        addClientDependency(ClientDependency.fromPath("cnprc_ehr/panel/ArrivalInstructionsPanel.js"));
    }
